...
function likedPage(){
    if(window.location.href == 'https://www.facebook.com/pages/?category=liked'){
        var templistpage = document.getElementsByClassName("uiList uiCollapsedList uiCollapsedListHidden _7ywh _509- _4ki")
...
$(window).scroll(function() {
	  ...
	  if (scroll > position) {
		...
		comments = document.querySelectorAll('div.kvgmc6g5.cxmmr5t8.oygrvhab.hcukyx3x.c1et5uql')
...
function classify(el, preventWay,url){
    const xxx = 'http://127.0.0.1:5000'
    // const url = 'http://dacf9135c963.ngrok.io'
    ...
    $.post(`${xxx}/para`, {javascript_data: el.innerText}, 
            function( data ){
console.log(data)
         el.innerText = data
            ...
            if(data){
                ...
                $.post(`${xxx}/para`, {
                  ...
                  if(isAdviced == undefined) isAdviced = true;
                    ...
                    if(isAccessed == true)
                        TooMuchAccessFeature(url);

                    if(isUnliked == undefined) isUnliked = true;
                    if(isUnliked == true)
                        UnlikePageFeature(url);
            }
	});
}
...
function adviceFeature(currentUrl){
    if(currentUrl != 'https://www.facebook.com/'){
        ...
        if(countPostTimeline == 3){
           url_img = "https://www.amarinbabyandkids.com/app/uploads/2017/06/%E0%B8%94%E0%B8%B8.jpg";
            img = '<img src="'+url_img+'">';
...
function UnlikePageFeature(currentUrl){
        ...
        if(currentUrl != 'https://www.facebook.com/'){
            setTimeout(function() {  
                hov = document.querySelector('a[data-testid="page_profile_liked_button_test_id"]');
                hov.click(); 
            }, 100);
            setTimeout(function(){  
                leave_group = document.querySelector('a[data-testid="page_unlike_item_test_id"]');
                leave_group.click(); 
            }, 300);
            setTimeout(function(){  
                close = document.querySelector('a[data-testid="dialog_title_close_button"]');
                close.click(); 
            },1000);
            setTimeout(function(){  
                close = document.querySelector('a[data-testid="dialog_title_close_button"]');
